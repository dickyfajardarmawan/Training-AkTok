...
import ShoppingCartSvc.service.ProdukService;
...
/**
 * Provides the base implementation for the produk remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ShoppingCartSvc.service.impl.ProdukServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProdukServiceBaseImpl extends BaseServiceImpl
	implements ProdukService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link ShoppingCartSvc.service.ProdukServiceUtil} to access the produk remote service.
	 */
	 ...
	 */
	public ShoppingCartSvc.service.CartService getCartService() {
		return cartService;
	}
	 ...
	 */
	public void setCartService(ShoppingCartSvc.service.CartService cartService) {
	...
	public String getOSGiServiceIdentifier() {
		return ProdukService.class.getName();
	}
	...
	@BeanReference(type = ShoppingCartSvc.service.CartService.class)
	protected ShoppingCartSvc.service.CartService cartService;
	...
	@BeanReference(type = ProdukService.class)
