 ...
 * @see ProdukModel
 * @see ShoppingCartSvc.model.impl.ProdukImpl
 * @see ShoppingCartSvc.model.impl.ProdukModelImpl
 * @generated
 */
@ImplementationClassName("ShoppingCartSvc.model.impl.ProdukImpl")
@ProviderType
public interface Produk extends ProdukModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link ShoppingCartSvc.model.impl.ProdukImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
