...
/**
 * Provides the local service interface for Toko. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TokoLocalServiceUtil
...
public interface TokoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TokoLocalServiceUtil} to access the toko local service. Add custom service methods to {@link TokoSvc.service.impl.TokoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Toko createToko(String id_toko);
	...
	*/
	...
	public Toko deleteToko(String id_toko) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Toko deleteToko(Toko toko);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Toko fetchToko(String id_toko);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Toko getToko(String id_toko) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Toko> getTokos(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Toko updateToko(Toko toko);
}