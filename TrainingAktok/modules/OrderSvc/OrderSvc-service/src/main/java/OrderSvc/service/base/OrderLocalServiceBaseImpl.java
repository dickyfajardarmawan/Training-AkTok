...
import OrderSvc.service.OrderLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link OrderSvc.service.impl.OrderLocalServiceImpl}.
 * </p>
 *
...
public abstract class OrderLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link OrderSvc.service.OrderLocalServiceUtil} to access the order local service.
	 */
	...
	public Order createOrder(String id_order) {
		return orderPersistence.create(id_order);
	}
	...
	public Order deleteOrder(String id_order) throws PortalException {
		return orderPersistence.remove(id_order);
	}
	...
	public Order fetchOrder(String id_order) {
		return orderPersistence.fetchByPrimaryKey(id_order);
	}
	...
	public Order getOrder(String id_order) throws PortalException {
		return orderPersistence.findByPrimaryKey(id_order);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("OrderSvc.model.Order",
			orderLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("OrderSvc.model.Order");
	}
