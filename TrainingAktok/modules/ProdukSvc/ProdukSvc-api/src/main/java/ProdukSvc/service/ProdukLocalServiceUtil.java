 ...
 * {@link ProdukSvc.service.impl.ProdukLocalServiceImpl} and is the
 ...
 * @see ProdukSvc.service.base.ProdukLocalServiceBaseImpl
 * @see ProdukSvc.service.impl.ProdukLocalServiceImpl
 * @generated
 */
@ProviderType
public class ProdukLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link ProdukSvc.service.impl.ProdukLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static ProdukSvc.model.Produk addProduk(
		ProdukSvc.model.Produk produk) {
		return getService().addProduk(produk);
	}

	public static ProdukSvc.model.Produk addProduk(String namaProduk,
		long hargaProduk, long kelipatanProduk) {
		return getService().addProduk(namaProduk, hargaProduk, kelipatanProduk);
	}
	...
	*/
	public static ProdukSvc.model.Produk createProduk(String id_produk) {
		return getService().createProduk(id_produk);
	}

	public static void deleteById(String idProduk)
		throws ProdukSvc.exception.NoSuchProdukException {
		getService().deleteById(idProduk);
	}
	...
	*/
	public static ProdukSvc.model.Produk deleteProduk(
		ProdukSvc.model.Produk produk) {
	...
	*/
	public static ProdukSvc.model.Produk deleteProduk(String id_produk)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static ProdukSvc.model.Produk fetchProduk(String id_produk) {
	...
	* @throws PortalException if a produk with the primary key could not be found
	*/
	public static ProdukSvc.model.Produk getProduk(String id_produk)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<ProdukSvc.model.Produk> getProduks(int start,
		int end) {
	...
	*/
	public static ProdukSvc.model.Produk updateProduk(
		ProdukSvc.model.Produk produk) {
		return getService().updateProduk(produk);
	}

	public static ProdukSvc.model.Produk updateProduk(String idProduk,
		String namaProduk, long hargaProduk, long kelipatanProduk) {
		return getService()
				   .updateProduk(idProduk, namaProduk, hargaProduk,
			kelipatanProduk);
	}
