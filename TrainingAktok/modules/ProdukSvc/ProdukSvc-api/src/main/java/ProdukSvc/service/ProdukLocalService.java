...
/**
 * Provides the local service interface for Produk. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProdukLocalServiceUtil
...
public interface ProdukLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProdukLocalServiceUtil} to access the produk local service. Add custom service methods to {@link ProdukSvc.service.impl.ProdukLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Produk addProduk(String namaProduk, long hargaProduk,
		long kelipatanProduk);
	...
	*/
	...
	public Produk createProduk(String id_produk);
	...
	*/
	...
	public Produk deleteProduk(Produk produk);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Produk deleteProduk(String id_produk) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Produk fetchProduk(String id_produk);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Produk getProduk(String id_produk) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Produk> getProduks(int start, int end);
	...
	*/
	...
	public Produk updateProduk(String idProduk, String namaProduk,
